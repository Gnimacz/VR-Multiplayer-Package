...
namespace gnimacz.vrmultiplayer.Lobbies.Online_Lobby
{
    ...
    public class OnlineLobbyManager : MonoBehaviour
    {
        ...
        {
            // Set a random profile name and number for the player to prevent any conflicts in the Lobby service.
            var options = new InitializationOptions().SetProfile("Player_" + UnityEngine.Random.Range(1000, 9999));
        ...
        /// </returns>
        public async Task<Lobby> StartHostRelayAsync()
        {
            try
            {
            ...
            var data = new Dictionary<string, DataObject>
            {
                { "RoomCode", new DataObject(DataObject.VisibilityOptions.Public, roomCode) },
                {
                    ...
                    new DataObject(DataObject.VisibilityOptions.Public,
                        (!string.IsNullOrEmpty(lobbyPassword)).ToString().ToLower())
                }
            };
        ...
        /// <summary>
        /// Queries the lobby service for all lobbies and returns a list of them.
        /// </summary>
        /// <returns> A list of all lobbies available in the lobby service.</returns>
        ...
        public void SetLobbyMaxPlayers(int maxPlayers) => this.maxPlayers = maxPlayers;
