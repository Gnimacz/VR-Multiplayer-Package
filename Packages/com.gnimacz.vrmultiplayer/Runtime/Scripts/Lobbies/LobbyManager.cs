...
public class LobbyManager : MonoBehaviour
{
    ...
    {
        return UseOnline ? await CreateOnlineLobby() : CreateLocalLobby();
    }
    ...
    /// </param>
    private void JoinLocalLobby(string roomCode)
    {
#if UNITY_EDITOR
        if (Settings.ShowDebugInformation.Value)
    ...
    /// for the local lobby.
    /// </returns>
    private LobbyCreationData CreateLocalLobby()
    {
